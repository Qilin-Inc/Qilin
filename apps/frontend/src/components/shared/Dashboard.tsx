...
const LeagueDashboard = () => {
  interface Player {
    ...
    kda: string;
    place: number;
    premium: boolean; // Premium account indicator
  }
          ...
          <TableBody>
            {filteredLeaderboard.map((player, index) => (
              <TableRow key={index} className="bg-gray-800">
                ...
                <TableCell>{player.premium ? player.stats : <span className="blur-sm">Hidden</span>}</TableCell>
                <TableCell>{player.premium ? player.winrate : <span className="blur-sm">Hidden</span>}</TableCell>
                <TableCell>{player.premium ? player.kda : <span className="blur-sm">Hidden</span>}</TableCell>
